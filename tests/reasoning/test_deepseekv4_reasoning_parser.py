...
from vllm.reasoning.deepseek_v4_reasoning_parser import (
    ...
    DeepSeekV4ReasoningWithThinkingParser,
...
def test_with_thinking_default_enables_thinking(tokenizer):
    parser = DeepSeekV4ReasoningWithThinkingParser(tokenizer)
    assert isinstance(parser._parser, DeepSeekV4ThinkingReasoningParser)

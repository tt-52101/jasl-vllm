...
class DeepSeekV4ReasoningWithThinkingParser(DeepSeekV4ReasoningParser):
    """
    :class:`DeepSeekV4ReasoningParser` that defaults to thinking mode when
    neither ``thinking`` nor ``enable_thinking`` is set in
